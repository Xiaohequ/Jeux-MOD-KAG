...
const SColor color_tdm2_player_respawner(0xff1EFF9D);
...
class TDMPNGLoader : PNGLoader
{
	...
	void handlePixel(SColor pixel, int offset)
	{
		...
		else if (pixel == color_tdm2_player_respawner) 
		{
			AddMarker( map, offset, "tdm2_spawn" );
		}
	}
...
{
    print("LOADING TDM2 PNG MAP " + fileName );
