...
void onTick(CSprite@ this)
{
    ...
    if (blob.getHealth() > 0.0)
    {
		...
		if( blob.hasTag(chomp_tag) && !this.isAnimation("bite"))
		{
			...
			this.PlaySound( "/ZombieBossAttack" );
		...
		else
		{
			if (XORRandom(20)==0)
			{
				this.PlaySound( "/ZombieBossGrowl" );
			}
...
void onGib(CSprite@ this)
{
    ...
    CParticle@ Body     = makeGibParticle( "ZombieBossGibs.png", pos, vel + getRandomVelocity( 90, hp , 80 ),       1, 0, Vec2f (8,8), 2.0f, 20, "/BodyGibFall", team );
    CParticle@ Arm1     = makeGibParticle( "ZombieBossGibs.png", pos, vel + getRandomVelocity( 90, hp - 0.2 , 80 ), 1, 1, Vec2f (8,8), 2.0f, 20, "/BodyGibFall", team );
    CParticle@ Arm2     = makeGibParticle( "ZombieBossGibs.png", pos, vel + getRandomVelocity( 90, hp - 0.2 , 80 ), 1, 2, Vec2f (8,8), 2.0f, 20, "/BodyGibFall", team );
    CParticle@ Shield   = makeGibParticle( "ZombieBossGibs.png", pos, vel + getRandomVelocity( 90, hp , 80 ),       1, 3, Vec2f (8,8), 2.0f, 0, "/BodyGibFall", team );
    CParticle@ Sword    = makeGibParticle( "ZombieBossGibs.png", pos, vel + getRandomVelocity( 90, hp + 1 , 80 ),   1, 4, Vec2f (8,8), 2.0f, 0, "/BodyGibFall", team );
