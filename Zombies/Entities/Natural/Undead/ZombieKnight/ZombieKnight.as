...
void onInit(CBlob@ this)
{
	...
	this.set_u16("bite freq", 50);

	//brain
	this.set_u8(personality_property, DEFAULT_PERSONALITY);
	this.set_u8("random move freq",4);
	this.set_f32(target_searchrad_property, 700.0f);
	this.set_f32(terr_rad_property, 300.0f);
	this.set_u8(target_lose_random,20);
						...
						for (uint i = 0; i < hitInfos.length; i++)
						{
							...
							if (other !is null)
							{
								...
								else if (!hit_block)
								{
									...
									{
										this.server_Hit(other,other.getPosition(),vel,0.5,Hitters::saw, false);
										this.set_u16("lastbite",0);
										hit_block=true;
									}
