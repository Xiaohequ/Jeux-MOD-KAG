...
void onCommand( CBlob@ this, u8 cmd, CBitStream @params )
{
	...
	}else if(cmd == this.getCommandID("vehicle getout"))
	{
		VehicleInfo@ v;
		if (!this.get( "VehicleInfo", @v )) {
			return;
		}
		resetWeaponArmAngle(this,v);
	}
}

void resetWeaponArmAngle(CBlob@ this, VehicleInfo@ v){
	Vehicle_SetWeaponAngle(this,0,v);
	CSprite@ sprite = this.getSprite();
	CSpriteLayer@ arm = sprite.getSpriteLayer( "arm" );
	if(v.ammo_stocked > 0){
		arm.animation.frame = 1;
