...
void SetupBackgrounds(CMap@ map)
{
	...
	map.CreateSky( color_white, Vec2f(20.0f,-135.0f), 10, "Sprites/Back/cloud1.png", 5);
	
	map.CreateSkyGradient( "Sprites/skygradient.png" ); // override sky color with gradient

	// plains

	map.AddBackground( "Sprites/Back/BackgroundPlains.png", Vec2f(0.0f, -120.0f), Vec2f(0.3f, 0.0f), color_white ); 
	map.AddBackground( "Sprites/Back/BackgroundTrees.png", Vec2f(0.0f,  -118.0f), Vec2f(0.4f, 0.5f), color_white ); 
	//map.AddBackground( "Sprites/Back/BackgroundIsland.png", Vec2f(0.0f, 50.0f), Vec2f(0.5f, 0.5f), color_white ); 
	map.AddBackground( "Sprites/Back/BackgroundCastle.png", Vec2f(0.0f, -115.0f), Vec2f(0.6f, 1.0f), color_white ); 
