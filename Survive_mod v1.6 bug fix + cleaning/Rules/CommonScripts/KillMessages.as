...
class KillFeed
{
    ...
    void Render()
    {
        ...
        for (uint message_step = 0; message_step < count; ++message_step)
        {
			...
			case Hitters::bite: hitterIcon = "$killfeed_zombie$"; break;
...
void onInit( CRules@ this )
{
    ...
    AddIconToken( "$killfeed_zombie$", "GUI/KillfeedIcons.png", Vec2f(32,16), 18 );
}
...
void onPlayerDie( CRules@ this, CPlayer@ victim, CPlayer@ killer, u8 customdata )
{
    if (victim !is null)
    {
        ...
        {
			if(killer !is null && killer.getBlob().hasTag("zombie"))
				customdata = Hitters::bite;
